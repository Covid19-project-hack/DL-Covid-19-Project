...
import com.dlcovid19project.Adapter.CoronaAdapter;
import com.dlcovid19project.Adapter.FAQAdapter;
import com.dlcovid19project.Models.Corona;
import com.dlcovid19project.Models.FAQ;
import com.dlcovid19project.Models.Persons;
        ...
        JsonObjectRequest request1 = new JsonObjectRequest(Request.Method.GET,url1, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            JSONObject jsonObject = response.getJSONObject("Telangana").getJSONObject("districtData");
